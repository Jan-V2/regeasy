...
RegeasyParser.RULE_prog = 0;
RegeasyParser.RULE_expr = 1;
...
function ProgContext(parser, parent, invokingState) {
    ...
    this.parser = parser;
    this.ruleIndex = RegeasyParser.RULE_prog;
    return this;
}
...
RegeasyParser.ProgContext = ProgContext;

RegeasyParser.prototype.prog = function() {

    var localctx = new ProgContext(this, this._ctx, this.state);
    this.enterRule(localctx, 0, RegeasyParser.RULE_prog);
    ...
    try {
        ...
        while(_la===RegeasyParser.T__4 || _la===RegeasyParser.INT) {
            this.state = 4;
            this.expr(0);
            this.state = 5;
...
function ExprContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = RegeasyParser.RULE_expr;
    return this;
}
...
RegeasyParser.prototype.expr = function(_p) {
	if(_p===undefined) {
	    _p = 0;
	}
    ...
    var _startState = 2;
    this.enterRecursionRule(localctx, 2, RegeasyParser.RULE_expr, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 18;
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 1:
                    ...
                    this.pushNewRecursionContext(localctx, _startState, RegeasyParser.RULE_expr);
                    this.state = 20;
                    ...
                    this.state = 21;
                    _la = this._input.LA(1);
                    if(!(_la===RegeasyParser.T__0 || _la===RegeasyParser.T__1)) {
                ...
                case 2:
                    ...
                    this.state = 24;
                    _la = this._input.LA(1);
                    if(!(_la===RegeasyParser.T__2 || _la===RegeasyParser.T__3)) {
                    this._errHandler.recoverInline(this);
                    }
                    else {
                        this.consume();
...
RegeasyParser.prototype.expr_sempred = function(localctx, predIndex) {
	switch(predIndex) {
		case 0:
